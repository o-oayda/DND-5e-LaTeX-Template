...
\DndArea[\ref{map:The Kingdom}]{Mount Doofus}
This area has a prefix before the number. The prefix is an optional parameter on |\DndArea|. Useful if your document contains multiple maps!
