...
\begin{DndTable}[header=Complex Theme Parameter Map]{clX}
  ...
  2 & \textit{commentcolor} & |DndComment| \\
    & \textit{sidebarcolor} & |DndSidebar| \\
  3 & \textit{readaloudcolor} & |DndReadAloud| background \\
  4 & \textit{readaloudbordercolor} & |DndReadAloud| border \\
  5 & \textit{titlecolor} & Titles of sections (|section|, |subsection|, etc) \\
  6 & \textit{titlerulecolor} & |subsection| title ruling \\
