...
\listparagraph[6pt]{Listparagraph}
{The listparagraph format allows hanging indented lists of options, such as those
used for class features and background skill/tool proficiency options.}

\listparagraph{Listparagraph}
{The listparagraph with no vertical space after the previous paragraph.}
